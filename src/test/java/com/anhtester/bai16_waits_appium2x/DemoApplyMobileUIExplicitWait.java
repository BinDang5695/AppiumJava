...
//        DriverManager.getDriver().findElement(AppiumBy.accessibilityId("View menu")).click();
        ...
        MobileUI.waitForElementVisible(AppiumBy.id("com.saucelabs.mydemoapp.android:id/loginTV"), 5);
        ...
        MobileUI.waitForElementVisible(AppiumBy.xpath("//android.widget.EditText[@resource-id=\"com.saucelabs.mydemoapp.android:id/nameET\"]"), 10);
